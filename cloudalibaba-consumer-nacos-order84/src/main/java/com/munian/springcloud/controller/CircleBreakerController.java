...
//    @SentinelResource(value = "fallback",blockHandler = "blockHandler")//只配置sentinel控制台配置违规
//    @SentinelResource(value = "fallback",fallback ="handlerFallback",blockHandler = "blockHandler")
    @SentinelResource(value = "fallback",fallback ="handlerFallback",blockHandler = "blockHandler",
    exceptionsToIgnore = {IllegalArgumentException.class})//配置此条属性，假如报该异常，不再有fallback方法兜底，没有降级效果（==4的时候）
